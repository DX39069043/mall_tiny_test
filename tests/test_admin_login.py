...
yamlhandler_data = yaml_handler.YamlHandler("E:/code/python/mall_tiny_test/data/login_data.yaml")
...
yamlhandler_param = yaml_handler.YamlHandler("E:/code/python/mall_tiny_test/data/login_param.yaml")
